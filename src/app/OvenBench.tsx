  ...
  return (
    <main className="shell">
      ...
      <footer>
        ...
        <div><a href="https://github.com/omeriadon/Tests/tree/cookiechain-ovenbench" target="_blank" rel="noreferrer">Source ↗</a><a href="https://www.cookiechain.wtf" target="_blank" rel="noreferrer">Cookie Chain ↗</a></div>
      </footer>
    </main>
  );
}
